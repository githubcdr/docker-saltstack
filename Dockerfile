...
RUN /venv/bin/pip install --no-cache-dir salt==${SALT_VERSION} pygit2==1.13.1 croniter tornado pycrypto backports.ssl_match_hostname cryptography distro pyyaml looseversion
